...
const popularCards = [
  { name: "Standard Business Card", image: "/images/cards/standard.png", slug: "standard-business-card" },
  { name: "Laminated Business Card", image: "/images/cards/laminated.png", slug: "laminated-business-card" },
  { name: "Textured Business Card", image: "/images/cards/textured.png", slug: "textured-business-card" },
  { name: "Metallic Business Card", image: "/images/cards/metallic.png", slug: "metallic-business-card" },
  { name: "Round Corner Business Card", image: "/images/cards/round.png", slug: "round-corner-business-card" },
  { name: "Cheap Business Card", image: "/images/cards/cheap.png", slug: "cheap-business-card" },
  { name: "Non-Tearable Business Card", image: "/images/cards/non.png", slug: "non-tearable-business-card" },
];

const premiumCards = [
  { name: "Spot UV Business Card", image: "/images/cards/spotuv.png", slug: "spot-uv-card" },
  { name: "Embossed Business Card", image: "/images/cards/embossed.png", slug: "embossed-card" },
  { name: "Foil Stamped Business Card", image: "/images/cards/foil.png", slug: "foil-card" },
  { name: "Eco Friendly Business Card", image: "/images/cards/eco.png", slug: "eco-card" },
  { name: "Transparent Business Card", image: "/images/cards/transparent.png", slug: "trans-card" },
  { name: "Custom Shape Business Card", image: "/images/cards/custome.png", slug: "custome-card" },
  { name: "PVC Business Card", image: "/images/cards/pvc.png", slug: "pvc-card" },
];

const specializedCards = [
  { name: "QR Business Card", image: "/images/cards/qr.png", slug: "qr-card" },
  { name: "PVC NFC Business Card", image: "/images/cards/nfc.png", slug: "nfc-card" },
  { name: "Metal NFC Business Card", image: "/images/cards/metalnfc.png", slug: "metal-nfc" },
];
  ...
  return (
    <section className="card-section">
      ...
      <div className="product-grid">
        {cards.map((card) => (
          <Link key={card.slug} to={`/products/${card.slug}`} className="card-link">
            <div className="stationery-card">
...
function BusinessCards() {
  return (
    <div className="business-cards-page container">
      <CardSection title="Most Popular Business Cards" cards={popularCards} />
      <CardSection title="Premium Business Cards" cards={premiumCards} />
      <CardSection title="Specialized Business Cards" cards={specializedCards} />
