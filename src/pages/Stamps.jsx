...
const stamps = [
  { name: "Self-Inking Stamps", image: "/images/stamps/self-ink.png", slug: "self-ink-stamp" },
  { name: "Pre-Ink Stamp", image: "/images/stamps/pre-ink.png", slug: "pre-ink-stamp" },
  { name: "Polymer Rubber Stamp", image: "/images/stamps/polymer.png", slug: "polymer-stamp" },
  { name: "Signature Stamp", image: "/images/stamps/signature.png", slug: "signature-stamp" },
  { name: "Pocket Stamp", image: "/images/stamps/pocket.png", slug: "pocket-stamp" },
  { name: "Embossing Stamp", image: "/images/stamps/emboss.png", slug: "emboss-stamp" },
  { name: "Pen Stamp", image: "/images/stamps/pen.png", slug: "pen-stamp" },
  { name: "Date/Number Stamp", image: "/images/stamps/date.png", slug: "date-stamp" },
  { name: "Fabric Stamp", image: "/images/stamps/fabric.png", slug: "fabric-stamp" },
];
  ...
  return (
    <div className="stamps-page">
      ...
      <div className="stamps-hero">
        <img src="/images/stamps/hero.png" alt="Custom Stamp & Ink" />
      </div>

      {/* TITLE */}
      <div className="stamps-title container">
        <h2>Custom Rubber Stamps in New Delhi</h2>
        <p>Custom stamp printing provides personalized and efficient solutions for document marking.</p>
      </div>

      {/* STAMP GRID */}
      <div className="container product-grid">
        {stamps.map((item) => (
          <Link key={item.slug} to={`/stamps/${item.slug}`} className="card-link">
            <div className="stationery-card">
