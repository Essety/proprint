...
<FiMail /> proprints@yahoo.com
</p>

<p className="footer-contact">
<FiPhone /> +91 91171 77979
</p>

<p className="footer-contact">
<FiMapPin /> 249/2, Ground Floor, Rama Market, Munirka, New Delhi - 110067
</p>
...
<Link to="/blog" className="footer-link">» Our Blog</Link>
...
<Link to="/refund" className="footer-link">» Refund & Return Policy</Link>
